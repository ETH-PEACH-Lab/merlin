...
import { Box, Typography, Card, CardContent, ListItemIcon, ListItemText, Popover, ListItem, List, IconButton, ButtonGroup, Tooltip } from "@mui/material";
...
const RendererSection = ({
  ...
  const { pages, addPage, removePage } = useParseCompile();
  const handleAddPage = () => {
