...
import { Box, Typography, Card, CardContent, ListItemIcon, ListItemText, Popover, ListItem, List, IconButton, ButtonGroup,
         Tooltip, TextField, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle } from "@mui/material";
...
const RendererSection = ({
  ...
  const { pages, addPage, removePage, createComponent } = useParseCompile();
