...
var grammar = {
    ...
    {"name": "commands$subexpression$1", "symbols": ["add_neuron_at_layer"]},
    ...
    {"name": "set_neuralnetwork_neuron", "symbols": ["set_neuralnetwork_neuron$macrocall$1"], "postprocess": (details) => ({ type: "set_neuralnetwork_neuron", target: "neurons", ...id(details) })},
    ...
    {"name": "set_neuralnetwork_neuron_color", "symbols": ["set_neuralnetwork_neuron_color$macrocall$1"], "postprocess": (details) => ({ type: "set_neuralnetwork_neuron", target: "neuronColors", ...id(details) })},
    ...
    {"name": "add_neuron_at_layer$macrocall$2", "symbols": [{"literal":"addNeurons"}]},
    {"name": "add_neuron_at_layer$macrocall$3$macrocall$2", "symbols": ["number"]},
    {"name": "add_neuron_at_layer$macrocall$3$macrocall$3", "symbols": ["nns_list"]},
    {"name": "add_neuron_at_layer$macrocall$3$macrocall$1", "symbols": ["add_neuron_at_layer$macrocall$3$macrocall$2", "_", "comma", "_", "add_neuron_at_layer$macrocall$3$macrocall$3"], "postprocess": ([x, , , , y]) => ({ index: id(x), value: id(y) })},
    {"name": "add_neuron_at_layer$macrocall$3", "symbols": ["add_neuron_at_layer$macrocall$3$macrocall$1"]},
    {"name": "add_neuron_at_layer$macrocall$1", "symbols": ["wordL", "dot", "add_neuron_at_layer$macrocall$2", "lparen", "_", "add_neuron_at_layer$macrocall$3", "_", "rparen"], "postprocess": ([wordL, dot, , , , args]) => ({ args: id(args), ...wordL })},
    {"name": "add_neuron_at_layer", "symbols": ["add_neuron_at_layer$macrocall$1"], "postprocess": (details) => ({ type: "insert_neuralnetwork_addNeurons", target1: "layers", target2: "neurons", ...id(details) })},
    ...
    {"name": "remove_layer", "symbols": ["remove_layer$macrocall$1"], "postprocess": (details) => ({ type: "remove_neuralnetwork_removeLayer", target1: "layers", target2: "neurons", target3: "layerColors", target4: "neuronColors", ...id(details) })},
