...
var grammar = {
    ...
    {"name": "set_values_multiple$macrocall$1", "symbols": ["word", "dot", "set_values_multiple$macrocall$2", "lparen", "_", "set_values_multiple$macrocall$3", "_", "rparen"], "postprocess": ([word, dot, , , , args]) => ({ args: id(args), ...word })},
    ...
    {"name": "set_colors_multiple$macrocall$1", "symbols": ["word", "dot", "set_colors_multiple$macrocall$2", "lparen", "_", "set_colors_multiple$macrocall$3", "_", "rparen"], "postprocess": ([word, dot, , , , args]) => ({ args: id(args), ...word })},
    ...
    {"name": "set_arrows_multiple$macrocall$1", "symbols": ["word", "dot", "set_arrows_multiple$macrocall$2", "lparen", "_", "set_arrows_multiple$macrocall$3", "_", "rparen"], "postprocess": ([word, dot, , , , args]) => ({ args: id(args), ...word })},
    ...
    {"name": "set_hidden_multiple$macrocall$1", "symbols": ["word", "dot", "set_hidden_multiple$macrocall$2", "lparen", "_", "set_hidden_multiple$macrocall$3", "_", "rparen"], "postprocess": ([word, dot, , , , args]) => ({ args: id(args), ...word })},
