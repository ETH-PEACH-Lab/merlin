...
var grammar = {
    ...
    {"name": "insert_node_2_args$macrocall$2$subexpression$1", "symbols": ["number"]},
    {"name": "insert_node_2_args$macrocall$2$subexpression$1", "symbols": ["word"]},
    {"name": "insert_node_2_args$macrocall$2", "symbols": ["insert_node_2_args$macrocall$2$subexpression$1"], "postprocess": id},
    {"name": "insert_node_2_args$macrocall$3", "symbols": ["word"]},
    {"name": "insert_node_2_args$macrocall$1", "symbols": ["insert_node_2_args$macrocall$2", "_", "comma", "_", "insert_node_2_args$macrocall$3"], "postprocess": ([x, , , , y]) => ({ index: id(x), value: id(y) })},
    {"name": "insert_node_2_args", "symbols": ["insert_node_2_args$macrocall$1"], "postprocess": ([indexOrNode, nodeName]) => ({ index: indexOrNode, value: nodeName })},
    {"name": "insert_node_3_args$macrocall$2$macrocall$2$subexpression$1", "symbols": ["number"]},
    {"name": "insert_node_3_args$macrocall$2$macrocall$2$subexpression$1", "symbols": ["word"]},
    {"name": "insert_node_3_args$macrocall$2$macrocall$2", "symbols": ["insert_node_3_args$macrocall$2$macrocall$2$subexpression$1"], "postprocess": id},
    {"name": "insert_node_3_args$macrocall$2$macrocall$3", "symbols": ["word"]},
    {"name": "insert_node_3_args$macrocall$2$macrocall$1", "symbols": ["insert_node_3_args$macrocall$2$macrocall$2", "_", "comma", "_", "insert_node_3_args$macrocall$2$macrocall$3"], "postprocess": ([x, , , , y]) => ({ index: id(x), value: id(y) })},
    {"name": "insert_node_3_args$macrocall$2", "symbols": ["insert_node_3_args$macrocall$2$macrocall$1"]},
    {"name": "insert_node_3_args$macrocall$3$subexpression$1", "symbols": ["number"]},
    {"name": "insert_node_3_args$macrocall$3$subexpression$1", "symbols": ["string"]},
    {"name": "insert_node_3_args$macrocall$3$subexpression$1", "symbols": ["nullT"]},
    {"name": "insert_node_3_args$macrocall$3", "symbols": ["insert_node_3_args$macrocall$3$subexpression$1"], "postprocess": id},
    {"name": "insert_node_3_args$macrocall$1", "symbols": ["insert_node_3_args$macrocall$2", "_", "comma", "_", "insert_node_3_args$macrocall$3"], "postprocess": ([x, , , , y]) => ({ index: id(x), value: id(y) })},
    {"name": "insert_node_3_args", "symbols": ["insert_node_3_args$macrocall$1"], "postprocess": ([indexAndNode, nodeValue]) => ({ index: indexAndNode.index, value: indexAndNode.value, nodeValue: nodeValue })},
