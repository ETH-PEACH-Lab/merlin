...
var grammar = {
    ...
    {"name": "definition$subexpression$1", "symbols": ["frame_def"]},
    ...
    {"name": "frame_def$macrocall$2", "symbols": [{"literal":"frame"}]},
    {"name": "frame_def$macrocall$3", "symbols": ["frame_pair"]},
    {"name": "frame_def$macrocall$1$macrocall$2", "symbols": ["frame_def$macrocall$3"]},
    {"name": "frame_def$macrocall$1$macrocall$1$ebnf$1", "symbols": []},
    {"name": "frame_def$macrocall$1$macrocall$1$ebnf$1$subexpression$1", "symbols": ["comma_nlow", "frame_def$macrocall$1$macrocall$2"]},
    {"name": "frame_def$macrocall$1$macrocall$1$ebnf$1", "symbols": ["frame_def$macrocall$1$macrocall$1$ebnf$1", "frame_def$macrocall$1$macrocall$1$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "frame_def$macrocall$1$macrocall$1$ebnf$2", "symbols": ["nlow"], "postprocess": id},
    {"name": "frame_def$macrocall$1$macrocall$1$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "frame_def$macrocall$1$macrocall$1", "symbols": ["lbracket", "nlow", "frame_def$macrocall$1$macrocall$2", "frame_def$macrocall$1$macrocall$1$ebnf$1", "frame_def$macrocall$1$macrocall$1$ebnf$2", "rbracket"], "postprocess":  d => {
            const firstXValue = d[2];
            const repetitionGroups = d[3];
            let result = {};
    ...
    {"name": "frame_def$macrocall$1", "symbols": ["frame_def$macrocall$2", "__", "wordL", "_", "equals", "_", "frame_def$macrocall$1$macrocall$1", "_"], "postprocess": ([type, , wordL, , , , body]) => ({ ...getDef(type), body: body, ...wordL })},
    {"name": "frame_def", "symbols": ["frame_def$macrocall$1"], "postprocess": id},
    {"name": "frame_pair$subexpression$1$macrocall$2", "symbols": [{"literal":"name"}]},
    {"name": "frame_pair$subexpression$1$macrocall$3", "symbols": ["string"]},
    {"name": "frame_pair$subexpression$1$macrocall$1", "symbols": ["frame_pair$subexpression$1$macrocall$2", "colon", "_", "frame_pair$subexpression$1$macrocall$3"], "postprocess": ([key, , , value]) => ({ [key]: id(value) })},
    {"name": "frame_pair$subexpression$1", "symbols": ["frame_pair$subexpression$1$macrocall$1"]},
    {"name": "frame_pair$subexpression$1$macrocall$5", "symbols": [{"literal":"variable"}]},
    {"name": "frame_pair$subexpression$1$macrocall$6", "symbols": ["w_list"]},
    {"name": "frame_pair$subexpression$1$macrocall$4", "symbols": ["frame_pair$subexpression$1$macrocall$5", "colon", "_", "frame_pair$subexpression$1$macrocall$6"], "postprocess": ([key, , , value]) => ({ [key]: id(value) })},
    {"name": "frame_pair$subexpression$1", "symbols": ["frame_pair$subexpression$1$macrocall$4"]},
    {"name": "frame_pair$subexpression$1$macrocall$8", "symbols": [{"literal":"value"}]},
    {"name": "frame_pair$subexpression$1$macrocall$9", "symbols": ["nns_list"]},
    {"name": "frame_pair$subexpression$1$macrocall$7", "symbols": ["frame_pair$subexpression$1$macrocall$8", "colon", "_", "frame_pair$subexpression$1$macrocall$9"], "postprocess": ([key, , , value]) => ({ [key]: id(value) })},
    {"name": "frame_pair$subexpression$1", "symbols": ["frame_pair$subexpression$1$macrocall$7"]},
    {"name": "frame_pair$subexpression$1$macrocall$11", "symbols": [{"literal":"color"}]},
    {"name": "frame_pair$subexpression$1$macrocall$12", "symbols": ["ns_list"]},
    {"name": "frame_pair$subexpression$1$macrocall$10", "symbols": ["frame_pair$subexpression$1$macrocall$11", "colon", "_", "frame_pair$subexpression$1$macrocall$12"], "postprocess": ([key, , , value]) => ({ [key]: id(value) })},
    {"name": "frame_pair$subexpression$1", "symbols": ["frame_pair$subexpression$1$macrocall$10"]},
    {"name": "frame_pair$subexpression$1$macrocall$14", "symbols": [{"literal":"position"}]},
    {"name": "frame_pair$subexpression$1$macrocall$15$subexpression$1", "symbols": ["ranged_tuple"]},
    {"name": "frame_pair$subexpression$1$macrocall$15$subexpression$1", "symbols": ["position_keyword"]},
    {"name": "frame_pair$subexpression$1$macrocall$15", "symbols": ["frame_pair$subexpression$1$macrocall$15$subexpression$1"], "postprocess": iid},
    {"name": "frame_pair$subexpression$1$macrocall$13", "symbols": ["frame_pair$subexpression$1$macrocall$14", "colon", "_", "frame_pair$subexpression$1$macrocall$15"], "postprocess": ([key, , , value]) => ({ [key]: id(value) })},
    {"name": "frame_pair$subexpression$1", "symbols": ["frame_pair$subexpression$1$macrocall$13"]},
    {"name": "frame_pair$subexpression$1$macrocall$17", "symbols": [{"literal":"title"}]},
    {"name": "frame_pair$subexpression$1$macrocall$18", "symbols": ["string"]},
    {"name": "frame_pair$subexpression$1$macrocall$16", "symbols": ["frame_pair$subexpression$1$macrocall$17", "colon", "_", "frame_pair$subexpression$1$macrocall$18"], "postprocess": ([key, , , value]) => ({ [key]: id(value) })},
    {"name": "frame_pair$subexpression$1", "symbols": ["frame_pair$subexpression$1$macrocall$16"]},
    {"name": "frame_pair$subexpression$1$macrocall$20", "symbols": [{"literal":"label"}]},
    {"name": "frame_pair$subexpression$1$macrocall$21", "symbols": ["string"]},
    {"name": "frame_pair$subexpression$1$macrocall$19", "symbols": ["frame_pair$subexpression$1$macrocall$20", "colon", "_", "frame_pair$subexpression$1$macrocall$21"], "postprocess": ([key, , , value]) => ({ [key]: id(value) })},
    {"name": "frame_pair$subexpression$1", "symbols": ["frame_pair$subexpression$1$macrocall$19"]},
    {"name": "frame_pair$subexpression$1$macrocall$23", "symbols": [{"literal":"above"}]},
    {"name": "frame_pair$subexpression$1$macrocall$24$subexpression$1", "symbols": ["string"]},
    {"name": "frame_pair$subexpression$1$macrocall$24$subexpression$1", "symbols": ["word"]},
    {"name": "frame_pair$subexpression$1$macrocall$24", "symbols": ["frame_pair$subexpression$1$macrocall$24$subexpression$1"], "postprocess": id},
    {"name": "frame_pair$subexpression$1$macrocall$22", "symbols": ["frame_pair$subexpression$1$macrocall$23", "colon", "_", "frame_pair$subexpression$1$macrocall$24"], "postprocess": ([key, , , value]) => ({ [key]: id(value) })},
    {"name": "frame_pair$subexpression$1", "symbols": ["frame_pair$subexpression$1$macrocall$22"]},
    {"name": "frame_pair$subexpression$1$macrocall$26", "symbols": [{"literal":"below"}]},
    {"name": "frame_pair$subexpression$1$macrocall$27$subexpression$1", "symbols": ["string"]},
    {"name": "frame_pair$subexpression$1$macrocall$27$subexpression$1", "symbols": ["word"]},
    {"name": "frame_pair$subexpression$1$macrocall$27", "symbols": ["frame_pair$subexpression$1$macrocall$27$subexpression$1"], "postprocess": id},
    {"name": "frame_pair$subexpression$1$macrocall$25", "symbols": ["frame_pair$subexpression$1$macrocall$26", "colon", "_", "frame_pair$subexpression$1$macrocall$27"], "postprocess": ([key, , , value]) => ({ [key]: id(value) })},
    {"name": "frame_pair$subexpression$1", "symbols": ["frame_pair$subexpression$1$macrocall$25"]},
    {"name": "frame_pair$subexpression$1$macrocall$29", "symbols": [{"literal":"left"}]},
    {"name": "frame_pair$subexpression$1$macrocall$30$subexpression$1", "symbols": ["string"]},
    {"name": "frame_pair$subexpression$1$macrocall$30$subexpression$1", "symbols": ["word"]},
    {"name": "frame_pair$subexpression$1$macrocall$30", "symbols": ["frame_pair$subexpression$1$macrocall$30$subexpression$1"], "postprocess": id},
    {"name": "frame_pair$subexpression$1$macrocall$28", "symbols": ["frame_pair$subexpression$1$macrocall$29", "colon", "_", "frame_pair$subexpression$1$macrocall$30"], "postprocess": ([key, , , value]) => ({ [key]: id(value) })},
    {"name": "frame_pair$subexpression$1", "symbols": ["frame_pair$subexpression$1$macrocall$28"]},
    {"name": "frame_pair$subexpression$1$macrocall$32", "symbols": [{"literal":"right"}]},
    {"name": "frame_pair$subexpression$1$macrocall$33$subexpression$1", "symbols": ["string"]},
    {"name": "frame_pair$subexpression$1$macrocall$33$subexpression$1", "symbols": ["word"]},
    {"name": "frame_pair$subexpression$1$macrocall$33", "symbols": ["frame_pair$subexpression$1$macrocall$33$subexpression$1"], "postprocess": id},
    {"name": "frame_pair$subexpression$1$macrocall$31", "symbols": ["frame_pair$subexpression$1$macrocall$32", "colon", "_", "frame_pair$subexpression$1$macrocall$33"], "postprocess": ([key, , , value]) => ({ [key]: id(value) })},
    {"name": "frame_pair$subexpression$1", "symbols": ["frame_pair$subexpression$1$macrocall$31"]},
    {"name": "frame_pair", "symbols": ["frame_pair$subexpression$1"], "postprocess": iid},
    ...
    {"name": "commands$subexpression$1", "symbols": ["add_frame_variable"]},
    {"name": "commands$subexpression$1", "symbols": ["remove_frame_variable"]},
    {"name": "commands$subexpression$1", "symbols": ["set_frame_variable_name"]},
    {"name": "commands$subexpression$1", "symbols": ["set_frame_variables"]},
    ...
    {"name": "set_value$macrocall$3$macrocall$2$subexpression$1", "symbols": ["string"]},
    ...
    {"name": "set_color$macrocall$3$macrocall$2$subexpression$1", "symbols": ["string"]},
    ...
    {"name": "add_frame_variable$macrocall$2", "symbols": [{"literal":"addVariable"}]},
    {"name": "add_frame_variable$macrocall$3", "symbols": ["add_variable_2_args"]},
    {"name": "add_frame_variable$macrocall$1", "symbols": ["wordL", "dot", "add_frame_variable$macrocall$2", "lparen", "_", "add_frame_variable$macrocall$3", "_", "rparen"], "postprocess": ([wordL, dot, , , , args]) => ({ args: id(args), ...wordL })},
    {"name": "add_frame_variable", "symbols": ["add_frame_variable$macrocall$1"], "postprocess": (details) => ({ type: "add_frame_variable", ...id(details) })},
    {"name": "add_frame_variable$macrocall$5", "symbols": [{"literal":"addVariable"}]},
    {"name": "add_frame_variable$macrocall$6", "symbols": ["add_variable_3_args"]},
    {"name": "add_frame_variable$macrocall$4", "symbols": ["wordL", "dot", "add_frame_variable$macrocall$5", "lparen", "_", "add_frame_variable$macrocall$6", "_", "rparen"], "postprocess": ([wordL, dot, , , , args]) => ({ args: id(args), ...wordL })},
    {"name": "add_frame_variable", "symbols": ["add_frame_variable$macrocall$4"], "postprocess": (details) => ({ type: "add_frame_variable", ...id(details) })},
    {"name": "add_variable_2_args$subexpression$1", "symbols": ["string"]},
    {"name": "add_variable_2_args$subexpression$1", "symbols": ["word"]},
    {"name": "add_variable_2_args$subexpression$2", "symbols": ["number"]},
    {"name": "add_variable_2_args$subexpression$2", "symbols": ["string"]},
    {"name": "add_variable_2_args$subexpression$2", "symbols": ["nullT"]},
    {"name": "add_variable_2_args", "symbols": ["add_variable_2_args$subexpression$1", "_", "comma", "_", "add_variable_2_args$subexpression$2"], "postprocess": ([varName, , , , value]) => ({ variable: id(varName), value: id(value), color: null })},
    {"name": "add_variable_3_args$subexpression$1", "symbols": ["string"]},
    {"name": "add_variable_3_args$subexpression$1", "symbols": ["word"]},
    {"name": "add_variable_3_args$subexpression$2", "symbols": ["number"]},
    {"name": "add_variable_3_args$subexpression$2", "symbols": ["string"]},
    {"name": "add_variable_3_args$subexpression$2", "symbols": ["nullT"]},
    {"name": "add_variable_3_args$subexpression$3", "symbols": ["string"]},
    {"name": "add_variable_3_args$subexpression$3", "symbols": ["nullT"]},
    {"name": "add_variable_3_args", "symbols": ["add_variable_3_args$subexpression$1", "_", "comma", "_", "add_variable_3_args$subexpression$2", "_", "comma", "_", "add_variable_3_args$subexpression$3"], "postprocess": ([varName, , , , value, , , , color]) => ({ variable: id(varName), value: id(value), color: id(color) })},
    {"name": "remove_frame_variable$macrocall$2", "symbols": [{"literal":"removeVariable"}]},
    {"name": "remove_frame_variable$macrocall$3$subexpression$1", "symbols": ["number"]},
    {"name": "remove_frame_variable$macrocall$3$subexpression$1", "symbols": ["word"]},
    {"name": "remove_frame_variable$macrocall$3", "symbols": ["remove_frame_variable$macrocall$3$subexpression$1"], "postprocess": id},
    {"name": "remove_frame_variable$macrocall$1", "symbols": ["wordL", "dot", "remove_frame_variable$macrocall$2", "lparen", "_", "remove_frame_variable$macrocall$3", "_", "rparen"], "postprocess": ([wordL, dot, , , , args]) => ({ args: id(args), ...wordL })},
    {"name": "remove_frame_variable", "symbols": ["remove_frame_variable$macrocall$1"], "postprocess": (details) => ({ type: "remove_frame_variable", ...id(details) })},
    {"name": "set_frame_variable_name$macrocall$2", "symbols": [{"literal":"setVariable"}]},
    {"name": "set_frame_variable_name$macrocall$3$macrocall$2$subexpression$1", "symbols": ["number"]},
    {"name": "set_frame_variable_name$macrocall$3$macrocall$2$subexpression$1", "symbols": ["string"]},
    {"name": "set_frame_variable_name$macrocall$3$macrocall$2$subexpression$1", "symbols": ["word"]},
    {"name": "set_frame_variable_name$macrocall$3$macrocall$2", "symbols": ["set_frame_variable_name$macrocall$3$macrocall$2$subexpression$1"], "postprocess": id},
    {"name": "set_frame_variable_name$macrocall$3$macrocall$3$subexpression$1", "symbols": ["string"]},
    {"name": "set_frame_variable_name$macrocall$3$macrocall$3$subexpression$1", "symbols": ["word"]},
    {"name": "set_frame_variable_name$macrocall$3$macrocall$3", "symbols": ["set_frame_variable_name$macrocall$3$macrocall$3$subexpression$1"], "postprocess": id},
    {"name": "set_frame_variable_name$macrocall$3$macrocall$1", "symbols": ["set_frame_variable_name$macrocall$3$macrocall$2", "_", "comma", "_", "set_frame_variable_name$macrocall$3$macrocall$3"], "postprocess": ([x, , , , y]) => ({ index: id(x), value: id(y) })},
    {"name": "set_frame_variable_name$macrocall$3", "symbols": ["set_frame_variable_name$macrocall$3$macrocall$1"]},
    {"name": "set_frame_variable_name$macrocall$1", "symbols": ["wordL", "dot", "set_frame_variable_name$macrocall$2", "lparen", "_", "set_frame_variable_name$macrocall$3", "_", "rparen"], "postprocess": ([wordL, dot, , , , args]) => ({ args: id(args), ...wordL })},
    {"name": "set_frame_variable_name", "symbols": ["set_frame_variable_name$macrocall$1"], "postprocess": (details) => ({ type: "set_frame_variable_name", ...id(details) })},
    {"name": "set_frame_variables$macrocall$2", "symbols": [{"literal":"setVariables"}]},
    {"name": "set_frame_variables$macrocall$3$macrocall$2$subexpression$1", "symbols": ["word"]},
    {"name": "set_frame_variables$macrocall$3$macrocall$2$subexpression$1", "symbols": ["pass"]},
    {"name": "set_frame_variables$macrocall$3$macrocall$2", "symbols": ["set_frame_variables$macrocall$3$macrocall$2$subexpression$1"], "postprocess": id},
    {"name": "set_frame_variables$macrocall$3$macrocall$1$ebnf$1", "symbols": ["nlow"], "postprocess": id},
    {"name": "set_frame_variables$macrocall$3$macrocall$1$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "set_frame_variables$macrocall$3$macrocall$1", "symbols": ["lbrac", "set_frame_variables$macrocall$3$macrocall$1$ebnf$1", "rbrac"], "postprocess": () => []},
    {"name": "set_frame_variables$macrocall$3$macrocall$1$macrocall$2", "symbols": ["set_frame_variables$macrocall$3$macrocall$2"]},
    {"name": "set_frame_variables$macrocall$3$macrocall$1$macrocall$1$macrocall$2", "symbols": ["set_frame_variables$macrocall$3$macrocall$1$macrocall$2"]},
    {"name": "set_frame_variables$macrocall$3$macrocall$1$macrocall$1$macrocall$1", "symbols": ["_", "set_frame_variables$macrocall$3$macrocall$1$macrocall$1$macrocall$2", "_"], "postprocess": ([, value, ]) => id(value)},
    {"name": "set_frame_variables$macrocall$3$macrocall$1$macrocall$1$ebnf$1", "symbols": []},
    {"name": "set_frame_variables$macrocall$3$macrocall$1$macrocall$1$ebnf$1$macrocall$2", "symbols": ["set_frame_variables$macrocall$3$macrocall$1$macrocall$2"]},
    {"name": "set_frame_variables$macrocall$3$macrocall$1$macrocall$1$ebnf$1$macrocall$1$macrocall$2", "symbols": ["set_frame_variables$macrocall$3$macrocall$1$macrocall$1$ebnf$1$macrocall$2"]},
    {"name": "set_frame_variables$macrocall$3$macrocall$1$macrocall$1$ebnf$1$macrocall$1$macrocall$1", "symbols": ["_", "set_frame_variables$macrocall$3$macrocall$1$macrocall$1$ebnf$1$macrocall$1$macrocall$2", "_"], "postprocess": ([, value, ]) => id(value)},
    {"name": "set_frame_variables$macrocall$3$macrocall$1$macrocall$1$ebnf$1$macrocall$1", "symbols": ["comma", "set_frame_variables$macrocall$3$macrocall$1$macrocall$1$ebnf$1$macrocall$1$macrocall$1"], "postprocess": ([, value]) => id(value)},
    {"name": "set_frame_variables$macrocall$3$macrocall$1$macrocall$1$ebnf$1", "symbols": ["set_frame_variables$macrocall$3$macrocall$1$macrocall$1$ebnf$1", "set_frame_variables$macrocall$3$macrocall$1$macrocall$1$ebnf$1$macrocall$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "set_frame_variables$macrocall$3$macrocall$1$macrocall$1", "symbols": ["set_frame_variables$macrocall$3$macrocall$1$macrocall$1$macrocall$1", "set_frame_variables$macrocall$3$macrocall$1$macrocall$1$ebnf$1"], "postprocess": (([first, rest]) => [...first, ...rest.flat()])},
    {"name": "set_frame_variables$macrocall$3$macrocall$1", "symbols": ["lbrac", "set_frame_variables$macrocall$3$macrocall$1$macrocall$1", "rbrac"], "postprocess": ([, content]) => content.flat()},
    {"name": "set_frame_variables$macrocall$3", "symbols": ["set_frame_variables$macrocall$3$macrocall$1"]},
    {"name": "set_frame_variables$macrocall$1", "symbols": ["wordL", "dot", "set_frame_variables$macrocall$2", "lparen", "_", "set_frame_variables$macrocall$3", "_", "rparen"], "postprocess": ([wordL, dot, , , , args]) => ({ args: id(args), ...wordL })},
    {"name": "set_frame_variables", "symbols": ["set_frame_variables$macrocall$1"], "postprocess": (details) => ({ type: "set_multiple", target: "variable", ...id(details) })},
    ...
    {"name": "word$subexpression$1", "symbols": [(lexer.has("x") ? {type: "x"} : x)]},
    {"name": "word", "symbols": ["word$subexpression$1"], "postprocess": ([[value]]) => value.value},
    {"name": "wordL$subexpression$1", "symbols": [(lexer.has("word") ? {type: "word"} : word)]},
    {"name": "wordL$subexpression$1", "symbols": [(lexer.has("x") ? {type: "x"} : x)]},
    {"name": "wordL", "symbols": ["wordL$subexpression$1"], "postprocess": ([[value]]) => ({name: value.value, line: value.line, col: value.col})},
