...
var grammar = {
    ...
    {"name": "show$ebnf$1$subexpression$1$macrocall$2", "symbols": ["number"]},
    {"name": "show$ebnf$1$subexpression$1$macrocall$3", "symbols": ["number"]},
    {"name": "show$ebnf$1$subexpression$1$macrocall$1", "symbols": ["lparen", "_", "show$ebnf$1$subexpression$1$macrocall$2", "_", "comma", "_", "show$ebnf$1$subexpression$1$macrocall$3", "_", "rparen"], "postprocess": ([, , x, , , , y, ]) => [x[0], y[0]]},
    {"name": "show$ebnf$1$subexpression$1", "symbols": ["_", "show$ebnf$1$subexpression$1$macrocall$1"]},
