...
import {
  parse
} from "./chunk-ANRK2YQ5.mjs";
import "./chunk-LRMH5SVI.mjs";
import "./chunk-35JY2GL3.mjs";
import "./chunk-BRDVDEBG.mjs";
import "./chunk-EXNQRX2Z.mjs";
import "./chunk-YXLPJYLG.mjs";
import "./chunk-ZADDGEJJ.mjs";
import {
  selectSvgElement
...
var drawElement4 = /* @__PURE__ */ __name((svg, element, startY, unit_id) => {
  ...
  lines.forEach((line, lineIndex) => {
    ...
    group.append("text").attr("x", elementX).attr("y", lineY).attr("fill", "black").attr("font-size", "20").attr("dominant-baseline", "hanging").attr("class", "textElement").text(formatValue(line));
  });
