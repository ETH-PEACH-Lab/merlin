...
import {
  parse
} from "./chunk-3ORXWDE6.mjs";
import "./chunk-CBEAP5TR.mjs";
import "./chunk-LZUFWDFS.mjs";
import "./chunk-HMFZPYDK.mjs";
import "./chunk-MOFP44ID.mjs";
import "./chunk-POJEEQYB.mjs";
import "./chunk-NLTORHXA.mjs";
import {
  selectSvgElement
...
var processItemsWithRelativePositioning = /* @__PURE__ */ __name((subDiagrams) => {
  ...
  subDiagrams.forEach((subDiagram, index) => {
    ...
    const group = {
      ...
      position: subDiagram.position && "column" in subDiagram.position ? subDiagram.position : void 0,
      ...
      if (group.position) {
        ...
        if (row >= 0 && row < layout.rows && col >= 0 && col < layout.columns) {
          itemsWithPositions.push({
            item: group,
            // Don't override the existing index
