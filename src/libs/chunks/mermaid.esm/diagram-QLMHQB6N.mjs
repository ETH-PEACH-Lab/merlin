...
import {
  parse
} from "./chunk-ZEI3AXJA.mjs";
import "./chunk-Y2N4ETR5.mjs";
import "./chunk-XRCD7NTR.mjs";
import "./chunk-Z3JQJP3T.mjs";
import "./chunk-MEJSMS3N.mjs";
import "./chunk-LKDAGDSD.mjs";
import "./chunk-SZXGS323.mjs";
import {
  selectSvgElement
...
var drawNode = /* @__PURE__ */ __name((svg, node, position, unit_id) => {
  ...
  group.append("text").attr("x", nodeX).attr("y", nodeY).attr("dy", ".35em").attr("fill", "black").attr("font-size", "12").attr("dominant-baseline", "middle").attr("text-anchor", "middle").attr("class", "nodeLabel").text(node.value || node.nodeId);
}, "drawNode");
...
var drawNode3 = /* @__PURE__ */ __name((svg, node, position, hasNext, unit_id) => {
  ...
  group.append("text").attr("x", nodeX + 30).attr("y", nodeY + 15).attr("dy", ".35em").attr("fill", "black").attr("font-size", "12").attr("dominant-baseline", "middle").attr("text-anchor", "middle").attr("class", "nodeLabel").text(node.value);
  if (node.arrow) {
    group.append("line").attr("x1", nodeX + 30).attr("y1", nodeY - 30).attr("x2", nodeX + 30).attr("y2", nodeY).attr("stroke", "black").attr("stroke-width", "2").attr("marker-end", "url(#arrowhead)");
    if (node.arrowLabel) {
      group.append("text").attr("x", nodeX + 30).attr("y", nodeY - 40).attr("fill", "black").attr("font-size", "16").attr("dominant-baseline", "middle").attr("text-anchor", "middle").attr("class", "arrowLabel").text(node.arrowLabel);
    }
  }
  if (hasNext) {
    group.append("line").attr("x1", nodeX + 60).attr("y1", nodeY + 15).attr("x2", nodeX + 60 + 60).attr("y2", nodeY + 15).attr("stroke", "black").attr("stroke-width", "2").attr("marker-end", "url(#arrowhead)");
  }
}, "drawNode");
