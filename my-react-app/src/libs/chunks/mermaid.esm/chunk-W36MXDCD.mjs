...
// ../parser/dist/chunks/mermaid-parser.core/chunk-Z2QGVYZW.mjs
...
var MermaidAstReflection = class extends AbstractAstReflection {
  ...
  getAllTypes() {
    return ["ArrayDiagram", "ArrayElement", "Common", "Info", "MatrixDiagram", "MatrixElement", "MatrixRow", "Packet", "PacketBlock", "Pie", "PieSection", "SubDiagram", "TestSlide", "TestSlidesDiagram", "VisSlidePage", "VisSlidesDiagram"];
  }
  computeIsSubtype(subtype, supertype) {
    switch (subtype) {
      case ArrayDiagram:
